    ...
    <>
      <Container>
        <div>
          ...
          <Input
            value={props.billing}
            onChange={(e) => props.setBill(e.currentTarget.value)}
          ></Input>
        </div>
        <div>
          Select Tip %
          <NumberContainer>
            <NumberInput
              onClick={() => props.setTip(5)}
              className={tips === 5 ? "me" : "notMe"}
            >
              5%
            </NumberInput>
            <NumberInput
              onClick={() => props.setTip(10)}
              className={tips === 10 ? "me" : "notMe"}
            >
              10%
            </NumberInput>
            <NumberInput
              onClick={() => props.setTip(15)}
              className={tips === 15 ? "me" : "notMe"}
            >
              15%
            </NumberInput>
            <NumberInput
              onClick={() => props.setTip(25)}
              className={tips === 25 ? "me" : "notMe"}
            >
              25%
            </NumberInput>
            <NumberInput
              onClick={() => props.setTip(50)}
              className={tips === 50 ? "me" : "notMe"}
            >
              50%
            </NumberInput>
            <CustomInput
              ...
              onChange={(e) => props.setTip(e.currentTarget.value)}
            ></CustomInput>
          </NumberContainer>
        </div>
        <div>
          ...
          <Input
            placeholder="1"
            value={props.people <= 0 ? "" : props.people}
            onChange={(e) => props.setPeople(e.currentTarget.value)}
